<template>
  <div class="card card-body">
    ...
    <div class="row mt-3 mb-3 px-3">
      <button type="button" class="btn btn-primary" @click="createDomain" :data-kt-indicator="is_loading? 'on':'off'" :disabled="is_loading">
...
export default {
  ...
  methods:{
    async createDomain(){
      ...
      await axios.post(route('dashboard.domains.store'), this.domain).then((res) => {
